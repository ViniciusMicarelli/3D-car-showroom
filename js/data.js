export const CARS = [
  {
    ...
    accent: '#ff2d2d',
    audio: 'public/models/audios/sf90.mp4',
  ...
  },
  {
    ...
    accent: '#ff4b1f',
    audio: 'public/models/audios/rs3.mp4',
  ...
  },
  {
    ...
    accent: '#cc0000',
    audio: 'public/models/audios/laferrari.mp4',
  ...
  },
  {
    ...
    accent: '#c8ff00',
    audio: 'public/models/audios/aventador.mp4',
  ...
  },
  {
    ...
    accent: '#8a2be2',
    audio: 'public/models/audios/revuelto.mp4',
    framing: { camera: [5.0, 1.45, 5.6], target: [0, 0.55, 0], scale: 1.0 }
  },
  {
    id: 'gtr',
    ...
    accent: '#ffb302',
    audio: 'public/models/audios/r35.mp4',
